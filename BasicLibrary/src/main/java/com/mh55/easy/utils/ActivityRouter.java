...
public class ActivityRouter {
    ...
    private static final ActivityRouter router = new ActivityRouter();
    ...
    public static synchronized void init(Context context) {
        ...
        ActivityRouter.context = context;
        if (context == null) {
    ...
    static class Navigation {
        ...
        public Navigation setDestination(String path) {
            ...
            intent.setComponent(new ComponentName(ActivityRouter.context, destination));
            return this;
        }

        public Navigation setDestination(Class<? extends Activity> activityClazz) {
            intent.setComponent(new ComponentName(ActivityRouter.context, activityClazz));
            return this;
        }
        ...
        public void navigate(Context context, int requestCode) {
            ...
            if (context == null) {
                startContext = ActivityRouter.context;
            }
    ...
    public static void startActivityForResult(
        ...
        Navigation navigation = ActivityRouter.getInstance().setDestination(activityName).putExtras(param);
    ...
    public static void startActivityForResult(
        ...
        Navigation navigation = ActivityRouter.getInstance().setDestination(activityClazz).putExtras(param);
        navigation.navigate(caller, resultCallback);
    }
    ...
    public static void startActivity(@Nullable Object starter, String activityName, Bundle param, int requestCode) {
        ActivityRouter.Navigation navigation = ActivityRouter.getInstance().setDestination(activityName).putExtras(param);
