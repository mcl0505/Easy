...
public class LabelsView extends ViewGroup implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            int type = mTypedArray.getInt(R.styleable.labels_view_label_selectType, 1);
            mSelectType = SelectType.get(type);

            mMaxSelect = mTypedArray.getInteger(R.styleable.labels_view_label_maxSelect, 0);
            mMinSelect = mTypedArray.getInteger(R.styleable.labels_view_label_minSelect, 0);
            mMaxLines = mTypedArray.getInteger(R.styleable.labels_view_label_maxLines, 0);
            isIndicator = mTypedArray.getBoolean(R.styleable.labels_view_label_isIndicator, false);

            mLabelGravity = mTypedArray.getInt(R.styleable.labels_view_label_gravity, mLabelGravity);
            mLabelWidth = mTypedArray.getLayoutDimension(R.styleable.labels_view_label_text_width, mLabelWidth);
            mLabelHeight = mTypedArray.getLayoutDimension(R.styleable.labels_view_label_text_height, mLabelHeight);

            if (mTypedArray.hasValue(R.styleable.labels_view_label_textColor)) {
                mTextColor = mTypedArray.getColorStateList(R.styleable.labels_view_label_textColor);
            } else {
                mTextColor = ColorStateList.valueOf(0xFF000000);
            }

            mTextSize = mTypedArray.getDimension(R.styleable.labels_view_label_textSize,
                    sp2px(14));
            if (mTypedArray.hasValue(R.styleable.labels_view_label_textPadding)) {
                int textPadding = mTypedArray.getDimensionPixelOffset(
                        R.styleable.labels_view_label_textPadding, 0);
                ...
                mTextPaddingLeft = mTypedArray.getDimensionPixelOffset(
                        R.styleable.labels_view_label_textPaddingLeft, dp2px(10));
                mTextPaddingTop = mTypedArray.getDimensionPixelOffset(
                        R.styleable.labels_view_label_textPaddingTop, dp2px(5));
                mTextPaddingRight = mTypedArray.getDimensionPixelOffset(
                        R.styleable.labels_view_label_textPaddingRight, dp2px(10));
                mTextPaddingBottom = mTypedArray.getDimensionPixelOffset(
                        R.styleable.labels_view_label_textPaddingBottom, dp2px(5));
            }

            mLineMargin = mTypedArray.getDimensionPixelOffset(R.styleable.labels_view_label_lineMargin, dp2px(5));
            mWordMargin = mTypedArray.getDimensionPixelOffset(R.styleable.labels_view_label_wordMargin, dp2px(5));
            if (mTypedArray.hasValue(R.styleable.labels_view_label_background)) {
                int labelBgResId = mTypedArray.getResourceId(R.styleable.labels_view_label_background, 0);
                if (labelBgResId != 0) {
                    mLabelBg = getResources().getDrawable(labelBgResId);
                } else {
                    int labelBgColor = mTypedArray.getColor(R.styleable.labels_view_label_background, Color.TRANSPARENT);
            ...
            isSingleLine = mTypedArray.getBoolean(R.styleable.labels_view_label_singleLine, false);
